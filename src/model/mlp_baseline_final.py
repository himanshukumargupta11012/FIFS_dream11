# python mlp_baseline_final.py -f 7_final -e 20 -dim 128 -batch_size 1024 -lr 0.005 -model_name test
...
def MLP_train(args):
    ...
    split_date = pd.to_datetime("2025-02-19")
    ...
    save_path = f'{current_dir}/../model_artifacts/{args.model_name}_d-{data_file_name}'
