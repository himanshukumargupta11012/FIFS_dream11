...
python model/predict_model.py --input_path testing_data/SquadPlayerNames_IndianT20League\ -\ Match_36.csv --model_name transformer_d-7_IPL_sd-2010-01-01_ed-2025-10-19